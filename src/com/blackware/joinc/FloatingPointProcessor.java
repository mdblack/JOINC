...
public class FloatingPointProcessor 
{
    ...
    public void decodeFloat(int opcode)
	{
		...
		if (processor.isCode(Processor.MICROCODE.PREFIX_ADDRESS_32BIT))
		{
		...
		{
	    case 0xd8:
	        processor.pushCode(Processor.MICROCODE.FWAIT);
	        if ((modrm & 0xc0) != 0xc0) 
	        {
	            switch (modrm & 0x38) 
	            {
	            ...
	            case 0x38:
	                ...
	                processor.pushCode(Processor.MICROCODE.FLOAD0_MEM_SINGLE);
	                processor.pushCode(Processor.MICROCODE.FLOAD1_ST0);                     
	                break;
	            default:
	                processor.pushCode(Processor.MICROCODE.FLOAD0_ST0); 
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.FLOAD1_MEM_SINGLE);
	                break;
	            }
	        } 
	        else 
	        {
	            ...
	            case 0xe8:
	            case 0xf8:
	                processor.pushCode(Processor.MICROCODE.FLOAD0_STN);
	                processor.pushCode(modrm & 0x07);
	                processor.pushCode(Processor.MICROCODE.FLOAD1_ST0);
	                break;
	            default:
	                processor.pushCode(Processor.MICROCODE.FLOAD0_ST0);
	                processor.pushCode(Processor.MICROCODE.FLOAD1_STN);
	                processor.pushCode(modrm & 0x07);
	                break;
	            }
	        }
    	...
    	case 0xd9:
	        if ((modrm & 0xc0) != 0xc0) 
	        {
	            ...
	            case 0x18: 
	                processor.pushCode(Processor.MICROCODE.FWAIT); 
	                processor.pushCode(Processor.MICROCODE.FLOAD0_ST0); break;
	            case 0x20:
	                processor.pushCode(Processor.MICROCODE.FWAIT);
	                processor.decode_memory(modrm, sib, displacement); 
	                break;
	            case 0x28:
	                processor.pushCode(Processor.MICROCODE.FWAIT);
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.LOAD0_MEM_WORD);
	                break;
	            case 0x30: processor.decode_memory(modrm, sib, displacement); break;
	            case 0x38: processor.pushCode(Processor.MICROCODE.LOAD0_FPUCW); break;
	            }
	        } 
	        else 
	        {
	            ...
	            case 0xfc:
	            case 0xfe:
	            case 0xff: processor.pushCode(Processor.MICROCODE.FLOAD0_ST0); break;
	            case 0xf1:
	            case 0xf3:
	            case 0xf5:
	            case 0xf8:
	            ...
	            case 0xe4:
	                processor.pushCode(Processor.MICROCODE.FLOAD0_ST0);
	                processor.pushCode(Processor.MICROCODE.FLOAD1_POS0);
	                break;
	            case 0xe8: processor.pushCode(Processor.MICROCODE.FLOAD0_1); break;
	            case 0xe9: processor.pushCode(Processor.MICROCODE.FLOAD0_L2TEN); break;
	            case 0xea: processor.pushCode(Processor.MICROCODE.FLOAD0_L2E); break;
	            case 0xeb: processor.pushCode(Processor.MICROCODE.FLOAD0_PI); break;
	            case 0xec: processor.pushCode(Processor.MICROCODE.FLOAD0_LOG2); break;
	            case 0xed: processor.pushCode(Processor.MICROCODE.FLOAD0_LN2); break;
	            case 0xee: processor.pushCode(Processor.MICROCODE.FLOAD0_POS0); break;
	            }
	        }
	        break;            
	    ...
	    case 0xda:
	        ...
	        if ((modrm & 0xc0) != 0xc0) 
	        {
	            ...
	            case 0x38:
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.LOAD0_MEM_DOUBLE);
	                processor.pushCode(Processor.MICROCODE.FLOAD0_REG0);
	                processor.pushCode(Processor.MICROCODE.FLOAD1_ST0);
	                break;
	            default:
	                processor.pushCode(Processor.MICROCODE.FLOAD0_ST0); 
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.LOAD0_MEM_DOUBLE);
	                processor.pushCode(Processor.MICROCODE.FLOAD1_REG0);
	                break;
	            }
	        } 
	        else 
	    ...
	    case 0xdb:
	        if ((modrm & 0xc0) != 0xc0) 
	        {
	            ...
	            case 0x10:
	            case 0x18:
	            case 0x38: processor.pushCode(Processor.MICROCODE.FLOAD0_ST0); break;
	            case 0x28:
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.FLOAD0_MEM_EXTENDED);
	                break;
	            }
	        } 
	        else 
	        {
	            ...
	            case 0xe2: 
	            case 0xe3: break;
	            default: processor.pushCode(Processor.MICROCODE.FWAIT); break;
	            }
	            switch (modrm & 0xf8) 
	            {
	            case 0xc0: 
	    ...
	    case 0xdc:
	        ...
	        if ((modrm & 0xc0) != 0xc0) 
	        {
	            ...
	            case 0x38:
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.FLOAD0_MEM_DOUBLE);
	                processor.pushCode(Processor.MICROCODE.FLOAD1_ST0);                     
	                break;
	            default:
	                processor.pushCode(Processor.MICROCODE.FLOAD0_ST0); 
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.FLOAD1_MEM_DOUBLE);
	                break;
	            }
	        } 
	        else 
	    ...
	    case 0xdd:
	        if ((modrm & 0xc0) != 0xc0) 
	        {
	            ...
	            case 0x20:
	                ...
	                break;
	            case 0x30: processor.decode_memory(modrm, sib, displacement); break;
	            case 0x38: processor.pushCode(Processor.MICROCODE.LOAD0_FPUSW); break;
	            }
	        } 
	        else 
	        {
	            ...
	            {
	            case 0xc0: 
	                processor.pushCode(Processor.MICROCODE.LOAD0_ID);
	                processor.pushCode(modrm & 0x07);
	                break;
	            case 0xd0: 
	            case 0xd8: processor.pushCode(Processor.MICROCODE.FLOAD0_ST0); break;
	            case 0xe0:
	            case 0xe8:
	                processor.pushCode(Processor.MICROCODE.FLOAD0_ST0);
	                processor.pushCode(Processor.MICROCODE.FLOAD1_STN);
	    ...
	    case 0xde:
	        ...
	        if ((modrm & 0xc0) != 0xc0) 
	        {
	            ...
	            case 0x30:
	                processor.pushCode(Processor.MICROCODE.FLOAD0_ST0); 
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.LOAD0_MEM_QUAD);
	                processor.pushCode(Processor.MICROCODE.FLOAD1_REG0L);
	                break;
	            default:
	                processor.pushCode(Processor.MICROCODE.FLOAD0_ST0); 
	                processor.decode_memory(modrm, sib, displacement);
	    ...
	    case 0xdf:
	        if ((modrm & 0xc0) != 0xc0) 
	        {
	            ...
	            case 0x28:
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.LOAD0_MEM_QUAD);
	                processor.pushCode(Processor.MICROCODE.FLOAD0_REG0L);
	                break;
	            case 0x08:
	            case 0x10:
	            case 0x18:
	        ...
	        else 
	        {
	            switch (modrm) 
	            {
	            case 0xe0: processor.pushCode(Processor.MICROCODE.LOAD0_FPUSW); break;
	            default: processor.pushCode(Processor.MICROCODE.FWAIT); break;
	            }
	            switch (modrm & 0xf8) {
	            case 0xe8:
		...
		if (opcode==0xd8)
		{
			switch(modrm&0x38)
			{
			case 0x00: processor.pushCode(Processor.MICROCODE.OP_FADD); break;
			case 0x08: processor.pushCode(Processor.MICROCODE.OP_FMUL); break;
			case 0x10: processor.pushCode(Processor.MICROCODE.OP_FCOM); break;
			case 0x18: processor.pushCode(Processor.MICROCODE.OP_FCOM); break;
			case 0x20: processor.pushCode(Processor.MICROCODE.OP_FSUB); break;
			case 0x28: processor.pushCode(Processor.MICROCODE.OP_FSUB); break;
			case 0x30: processor.pushCode(Processor.MICROCODE.OP_FDIV); break;
			case 0x38: processor.pushCode(Processor.MICROCODE.OP_FDIV); break;
			}
		}
		else if (opcode==0xd9)
		{
			if ((modrm & 0xc0) != 0xc0)
			{
				switch (modrm & 0x38) 
				{
					case 0x00: processor.pushCode(Processor.MICROCODE.OP_FPUSH); break;
					case 0x20:
						if (processor.isCode(Processor.MICROCODE.PREFIX_OPCODE_32BIT))
							processor.pushCode(Processor.MICROCODE.OP_FLDENV_28);
						else
							processor.pushCode(Processor.MICROCODE.OP_FLDENV_14);
						break;
					case 0x30:
						if (processor.isCode(Processor.MICROCODE.PREFIX_OPCODE_32BIT))
							processor.pushCode(Processor.MICROCODE.OP_FSTENV_28);
						else
							processor.pushCode(Processor.MICROCODE.OP_FSTENV_14);
						break;
				}
			}
			else
			{
				switch (modrm & 0xf8) 
				{
					case 0xc0: processor.pushCode(Processor.MICROCODE.OP_FPUSH); break;
				}                
				switch (modrm) 
				{
			        case 0xd0: break;
			        case 0xe0: processor.pushCode(Processor.MICROCODE.OP_FCHS); break;
			        case 0xe1: processor.pushCode(Processor.MICROCODE.OP_FABS); break;
			        case 0xe4: processor.pushCode(Processor.MICROCODE.OP_FCOM); break;
			        case 0xe5: processor.pushCode(Processor.MICROCODE.OP_FXAM); break;
			        case 0xe8: processor.pushCode(Processor.MICROCODE.OP_FPUSH); break;
			        case 0xe9: processor.pushCode(Processor.MICROCODE.OP_FPUSH); break;
			        case 0xea: processor.pushCode(Processor.MICROCODE.OP_FPUSH); break;
			        case 0xeb: processor.pushCode(Processor.MICROCODE.OP_FPUSH); break;
			        case 0xec: processor.pushCode(Processor.MICROCODE.OP_FPUSH); break;
			        case 0xed: processor.pushCode(Processor.MICROCODE.OP_FPUSH); break;
			        case 0xee: processor.pushCode(Processor.MICROCODE.OP_FPUSH); break;
			        case 0xf0: processor.pushCode(Processor.MICROCODE.OP_F2XM1); break;
			        case 0xf1: processor.pushCode(Processor.MICROCODE.OP_FYL2X); break;
			        case 0xf2: processor.pushCode(Processor.MICROCODE.OP_FPTAN); break;
			        case 0xf3: processor.pushCode(Processor.MICROCODE.OP_FPATAN); break;
			        case 0xf4: processor.pushCode(Processor.MICROCODE.OP_FXTRACT); break;
			        case 0xf5: processor.pushCode(Processor.MICROCODE.OP_FPREM1); break;
			        case 0xf6: processor.pushCode(Processor.MICROCODE.OP_FDECSTP); break;
			        case 0xf7: processor.pushCode(Processor.MICROCODE.OP_FINCSTP); break;
			        case 0xf8: processor.pushCode(Processor.MICROCODE.OP_FPREM); break;
			        case 0xf9: processor.pushCode(Processor.MICROCODE.OP_FYL2XP1); break;
			        case 0xfa: processor.pushCode(Processor.MICROCODE.OP_FSQRT); break;
			        case 0xfb: processor.pushCode(Processor.MICROCODE.OP_FSINCOS); break;
			        case 0xfc: processor.pushCode(Processor.MICROCODE.OP_FRNDINT); break;
			        case 0xfd: processor.pushCode(Processor.MICROCODE.OP_FSCALE); break;
			        case 0xfe: processor.pushCode(Processor.MICROCODE.OP_FSIN); break;
			        case 0xff: processor.pushCode(Processor.MICROCODE.OP_FCOS); break;
				}
			}
		}
		else if (opcode==0xda)
		{
		    ...
		    else
		    {
		        switch (modrm & 0xf8) 
		        {
		        case 0xc0: processor.pushCode(Processor.MICROCODE.OP_FCMOVB); break;
		        case 0xc8: processor.pushCode(Processor.MICROCODE.OP_FCMOVE); break;
		        case 0xd0: processor.pushCode(Processor.MICROCODE.OP_FCMOVBE); break;
		        case 0xd8: processor.pushCode(Processor.MICROCODE.OP_FCMOVU); break;
		        }                
		        switch (modrm) 
		        {
		        case 0xe9: processor.pushCode(Processor.MICROCODE.OP_FUCOM); break;
		        }
		    }			
		}
		...
		else if (opcode==0xdb)
		{
		    if ((modrm & 0xc0) != 0xc0)
		    {
		        ...
		        {
		        case 0x00: processor.pushCode(Processor.MICROCODE.OP_FPUSH); break;
		        case 0x08: processor.pushCode(Processor.MICROCODE.OP_FCHOP); break;
		        case 0x10:
		        case 0x18: processor.pushCode(Processor.MICROCODE.OP_FRNDINT); break;
		        case 0x28: processor.pushCode(Processor.MICROCODE.OP_FPUSH); break;
		        case 0x38: break;
		        }
		    }
		    else
		    {
		        switch (modrm & 0xf8) 
		        {
		        case 0xc0: processor.pushCode(Processor.MICROCODE.OP_FCMOVNB); break;
		        case 0xc8: processor.pushCode(Processor.MICROCODE.OP_FCMOVNE); break;
		        case 0xd0: processor.pushCode(Processor.MICROCODE.OP_FCMOVNBE); break;
		        case 0xd8: processor.pushCode(Processor.MICROCODE.OP_FCMOVNU); break;
		        case 0xe8: processor.pushCode(Processor.MICROCODE.OP_FUCOMI); break;
		        case 0xf0: processor.pushCode(Processor.MICROCODE.OP_FCOMI); break;
		        }                
		        switch (modrm) 
		        {
		        case 0xe2: processor.pushCode(Processor.MICROCODE.OP_FCLEX); break;
		        case 0xe3: processor.pushCode(Processor.MICROCODE.OP_FINIT); break;
		        case 0xe4: break;
		        }
		    }			
		}
		...
		else if (opcode==0xdd)
		{
		    if ((modrm & 0xc0) != 0xc0)
		    {
		        ...
		        case 0x20: 
		            if (processor.isCode(Processor.MICROCODE.PREFIX_OPCODE_32BIT))
		                processor.pushCode(Processor.MICROCODE.OP_FRSTOR_108); 
		            else
		                processor.pushCode(Processor.MICROCODE.OP_FRSTOR_94); 
		            break;
		        case 0x30: 
		            if (processor.isCode(Processor.MICROCODE.PREFIX_OPCODE_32BIT))
		                processor.pushCode(Processor.MICROCODE.OP_FSAVE_108); 
		            else
		                processor.pushCode(Processor.MICROCODE.OP_FSAVE_94); 
		            break;
		        }
		    }
		    else
		    {
		        switch (modrm & 0xf8) 
		        {
		        case 0xc0: processor.pushCode(Processor.MICROCODE.OP_FFREE); break;
		        case 0xd0:
		        case 0xd8: break;
		        case 0xe0:
		        case 0xe8: processor.pushCode(Processor.MICROCODE.OP_FUCOM); break;
		        }
		    }			
		}
		else if (opcode==0xde)
		{
		    switch (modrm) 
		    {
		    case 0xd9: processor.pushCode(Processor.MICROCODE.OP_FCOM); break;
		    default:
		        switch (modrm & 0x38) 
		        {
		        case 0x00: processor.pushCode(Processor.MICROCODE.OP_FADD); break;
		...
		else if (opcode==0xdf)
		{
		    if ((modrm & 0xc0) != 0xc0)
		    {
		        ...
		        case 0x10: 
		        case 0x18: 
		        case 0x38: processor.pushCode(Processor.MICROCODE.OP_FRNDINT); break;
		        case 0x20: processor.pushCode(Processor.MICROCODE.OP_FBCD2F); break;
		        case 0x28: processor.pushCode(Processor.MICROCODE.OP_FPUSH); break;
		        case 0x30: processor.pushCode(Processor.MICROCODE.OP_FF2BCD); break;
		        }
		    }
		    else
		    {
	    ...
	    case 0xd8:
	        ...
	        case 0x30:
	        case 0x38: 
	            processor.pushCode(Processor.MICROCODE.FSTORE0_ST0); 
	            processor.pushCode(Processor.MICROCODE.OP_FCHECK0);
	            break;
	        case 0x10: break;
	        case 0x18: processor.pushCode(Processor.MICROCODE.OP_FPOP); break;
	        }
	        break;            
	    ...
	    case 0xd9:
	        if ((modrm & 0xc0) != 0xc0)
	        {
	            ...
	            case 0x10:
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.FSTORE0_MEM_SINGLE);
	                break;
	            case 0x18:
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.FSTORE0_MEM_SINGLE);
	                processor.pushCode(Processor.MICROCODE.OP_FPOP);
	                break;
	            case 0x28: processor.pushCode(Processor.MICROCODE.STORE0_FPUCW); break;
	            case 0x38:
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.STORE0_MEM_WORD);
	                break;
	            }
	        }
	        else
	        {
	            ...
	            case 0xc0: break;
	            case 0xc8:
	                processor.pushCode(Processor.MICROCODE.FSTORE0_STN);
	                processor.pushCode(modrm & 0x07);
	                processor.pushCode(Processor.MICROCODE.FSTORE1_ST0);
	                break;
	            }
	            switch (modrm) 
	            {
	            ...
	            case 0xe1:
	            case 0xfe:
	            case 0xff: processor.pushCode(Processor.MICROCODE.FSTORE0_ST0); break;
	            case 0xf0:
	            case 0xf5:
	            case 0xf8:
	            case 0xfa:
	            ...
	            case 0xf2:
	                processor.pushCode(Processor.MICROCODE.FSTORE0_ST0);
	                processor.pushCode(Processor.MICROCODE.FLOAD0_1);
	                processor.pushCode(Processor.MICROCODE.OP_FPUSH);
	                break;
	            case 0xf1:
	            case 0xf3:
	                processor.pushCode(Processor.MICROCODE.OP_FPOP);
	            ...
	            case 0xfb:
	                ...
	                processor.pushCode(Processor.MICROCODE.OP_FPUSH);
	                processor.pushCode(Processor.MICROCODE.OP_FCHECK0); 
	                processor.pushCode(Processor.MICROCODE.OP_FCHECK1); 
	                break;
	            }
	        }
	        break;            
	    ...
	    case 0xdb:
	        if ((modrm & 0xc0) != 0xc0) 
	        {
	            ...
	            case 0x10:
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.STORE0_MEM_DOUBLE);
	                break;
	            case 0x08:
	            case 0x18:
	                processor.decode_memory(modrm, sib, displacement);
	            ...
	            case 0x38:
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.FSTORE0_MEM_EXTENDED); 
	                processor.pushCode(Processor.MICROCODE.OP_FPOP); 
	                break;
	            }
	        } 
	    ...
	    case 0xdd:
	        if ((modrm & 0xc0) != 0xc0) 
	        {
	            ...
	            case 0x08:
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.STORE0_MEM_QUAD);
	                processor.pushCode(Processor.MICROCODE.OP_FPOP);
	                break;
	            case 0x10:
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.FSTORE0_MEM_DOUBLE);
	                break;
	            case 0x18:
	                processor.decode_memory(modrm, sib, displacement);
	                processor.pushCode(Processor.MICROCODE.FSTORE0_MEM_DOUBLE);
	        ...
	        else 
	        {
	            ...
	            case 0xd8:
	                ...
	                processor.pushCode(Processor.MICROCODE.OP_FPOP);
	                break;
	            case 0xe8: processor.pushCode(Processor.MICROCODE.OP_FPOP); break;
	            }
	        }
	        break;            
	    ...
	    case 0xdf:
	        ...
	        else 
	        {
	            ...
	            {
	            case 0xe8:
	            case 0xf0: processor.pushCode(Processor.MICROCODE.OP_FPOP); break;
	            }
	            switch (modrm) 
	            {
	            case 0xe0: processor.pushCode(Processor.MICROCODE.STORE0_AX); break;
	            }
	        }
	        break;            
	...
	private void pushInstruction(Processor.MICROCODE microcode)
	{
	String name="";
	switch(microcode)
	{
	...
	if(processor.processorGUICode!=null) processor.processorGUICode.push(Processor.GUICODE.DECODE_INSTRUCTION, name);		
	}
	...
	public boolean executeFloat(Processor.MICROCODE microcode, int reg0, int reg1, int reg2, int addr0, long reg0l, Processor.Segment seg0, boolean condition, int displacement)
	{
...
freg0 = Math.cos(freg0);
    ...
    case OP_FPREM: {
       	processor.panic("FPREM");
        
       	int d = (int)(Math.exp(freg0) - Math.exp(freg1));
        if (d < 64)
        {
            // full remainder
...
//    case OP_FSCALE: freg0 = Math.scalb(freg0, (int) freg1); break;
    ...
    case OP_FXTRACT: {
    	processor.panic("FXTRACT");
    }
    	/*
//        int e = Math.getExponent(freg0);
    	int e=(int)Math.exp(freg0);
        freg1 = (double) e;
